...
public class ShieldVFX : AttachmentObject
{
    ...
    public virtual void ConstructStateMachine()
    {
        ...
        var appearState = mainLayer.CreateState("wooden_shield/wood_shield_appear", 0, false);
        var idleState = mainLayer.CreateState("wooden_shield/wood_shield_idle", 0, true);
        var hitState = mainLayer.CreateState("wooden_shield/wood_shield_hit", 0, false);
        var disappearState = mainLayer.CreateState("wooden_shield/wood_shield_disappear", 0, false);
        var breakState = mainLayer.CreateState("wooden_shield/wood_shield_break", 0, false);
