...
public static partial class SkillConfig
{
    ...
    public static readonly SkillTreeNodeConfig PunchNodeConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/basic/punch.png",
        MaximumLevel = 1,
    ...
    public static readonly SkillTreeNodeConfig PunchTwoConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/basic/punch2.png",
        MaximumLevel = 1,
        NeedRemover = true,
        NType = NodeType.SkillReplace,
        NTab = SkillTreeTabs.Basic,
    ...
    public static readonly SkillTreeNodeConfig PunchThreeConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/basic/punch3.png",
        UnlockLevel = 19,
        MaximumLevel = 1,
        NeedRemover = true,
        NType = NodeType.SkillReplace,
    ...
    public static readonly SkillTreeNodeConfig RollOutNodeConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/defense/rollout.png",
    ...
    public static readonly SkillTreeNodeConfig ShieldConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/defense/shield.png",
        ParentNodeKeys = new string[] { },
    ...
    public static readonly SkillTreeNodeConfig IronSkinConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/defense/iron_aura.png",
        ParentNodeKeys = new string[] { "Shield" },
    ...
    public static readonly SkillTreeNodeConfig SpikeShieldConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/defense/spike_guard.png",
    ...
    public static readonly SkillTreeNodeConfig GravityCrushConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/defense/gravity_crush.png",
    ...
    public static readonly SkillTreeNodeConfig ParryConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/defense/parry.png",
    ...
    public static readonly SkillTreeNodeConfig FlashOfSteelConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/defense/flash_of_steel.png",
    ...
    public static readonly SkillTreeNodeConfig BladeFrenzyConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/defense/blade_frenzy.png",
    ...
    public static readonly SkillTreeNodeConfig ShoulderCrashNodeConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/brawler/shoulder_crash.png",
        ParentNodeKeys = new string[] { },
    ...
    public static readonly SkillTreeNodeConfig GroundStompConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/brawler/ground_stomp.png",
        UnlockLevel = 8,
        MaximumLevel = 5,
        UpgradeGemCost = _tierOneGemCost,
        NType = NodeType.SkillUnlock,
    ...
    public static readonly SkillTreeNodeConfig RageConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/brawler/rage.png",
        CooldownKey = "%OVERRIDE%",
        UnlockLevel = 4,
        MaximumLevel = 5,
        UpgradeGemCost = _tierOneGemCost,
    ...
    public static readonly SkillTreeNodeConfig DoublePunchConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/brawler/double_punch.png",
        UnlockLevel = 2,
        MaximumLevel = 5,
        UpgradeGemCost = _tierOneGemCost,
        NType = NodeType.SkillUnlock,
    ...
    public static readonly SkillTreeNodeConfig SelfDestructConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/brawler/self_destruct.png",
        UnlockLevel = 25,
        MaximumLevel = 5,
        UpgradeGemCost = _tierTwoGemCost,
        NType = NodeType.SkillUnlock,
    ...
    public static readonly SkillTreeNodeConfig BattleCryConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/brawler/battle_cry.png",
        UnlockLevel = 15,
        MaximumLevel = 5,
        NType = NodeType.SkillUnlock,
        NTab = SkillTreeTabs.Brawler,
    ...
    public static readonly SkillTreeNodeConfig ClawSlashConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/brawler/claw_slash.png",
        UnlockLevel = 12,
        MaximumLevel = 5,
        UpgradeGemCost = _tierTwoGemCost,
        NType = NodeType.SkillUnlock,
    ...
    public static readonly SkillTreeNodeConfig DualClawConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/brawler/dual_claw.png",
        UnlockLevel = 22,
        MaximumLevel = 1,
    ...
    public static readonly SkillTreeNodeConfig LeapSlamConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/brawler/leaping_fist_slam.png",
        UnlockLevel = 17,
        MaximumLevel = 5,
        UpgradeGemCost = _tierTwoGemCost,
        NType = NodeType.SkillUnlock,
    ...
    public static readonly SkillTreeNodeConfig BladeStormConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/brawler/blade_storm.png",
        UnlockLevel = 38,
        MaximumLevel = 5,
        UpgradeGemCost = _tierThreeGemCost,
        NType = NodeType.SkillUnlock,
    ...
    public static readonly SkillTreeNodeConfig SpoonThrowConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/psionic/spoon_throw.png",
        UnlockLevel = 0,
        MaximumLevel = 5,
        UpgradeGemCost = _tierOneGemCost,
        GridX = 1,
    ...
    public static readonly SkillTreeNodeConfig BefuddleConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/psionic/befuddle.png",
        UnlockLevel = 5,
        MaximumLevel = 5,
        UpgradeGemCost = _tierOneGemCost,
        GridX = 0,
    ...
    public static readonly SkillTreeNodeConfig PsyboltConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/psionic/psybolt.png",
        UnlockLevel = 6,
        MaximumLevel = 5,
        UpgradeGemCost = _tierOneGemCost,
        GridX = 1,
    ...
    public static readonly SkillTreeNodeConfig SelfHealConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/psionic/self_heal.png",
        UnlockLevel = 2,
        MaximumLevel = 5,
        UpgradeGemCost = _tierOneGemCost,
        GridX = 2,
    ...
    public static readonly SkillTreeNodeConfig RegenerationConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/psionic/regeneration.png",
        UnlockLevel = 11,
        MaximumLevel = 5,
        UpgradeGemCost = _tierTwoGemCost,
        GridX = 2,
    ...
    public static readonly SkillTreeNodeConfig HypnotizeConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/psionic/hypnotize.png",
        UnlockLevel = 14,
        MaximumLevel = 5,
        UpgradeGemCost = _tierTwoGemCost,
        GridX = 0,
    ...
    public static readonly SkillTreeNodeConfig PsionicBeamConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/psionic/psionic_beam.png",
        UnlockLevel = 19,
        MaximumLevel = 5,
        UpgradeGemCost = _tierTwoGemCost,
        GridX = 1,
    ...
    public static readonly SkillTreeNodeConfig PsyThrowConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/psionic/psythrow.png",
        UnlockLevel = 24,
        MaximumLevel = 5,
        UpgradeGemCost = _tierTwoGemCost,
        GridX = 0,
    ...
    public static readonly SkillTreeNodeConfig PsychicConfig = new SkillTreeNodeConfig()
    {
        ...
        //AbilityPreviewPath = "Ability_Preview/psionic/psychic_mastery.png",
        UnlockLevel = 29,
        MaximumLevel = 1,
        GridX = 1,
        GridY = 3,
    ...
    public static readonly SkillTreeNodeConfig InvisibilityConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/stealth/invisibility.png",
        UnlockLevel = 0,
        MaximumLevel = 5,
        UpgradeGemCost = _tierOneGemCost,
        GridX = 1,
    ...
    public static readonly SkillTreeNodeConfig LightFeetConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/stealth/light_feet.png",
    ...
    public static readonly SkillTreeNodeConfig ShurikenConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/stealth/shuriken.png",
        UnlockLevel = 7,
        MaximumLevel = 5,
        UpgradeGemCost = _tierOneGemCost,
        GridX = 1,
    ...
    public static readonly SkillTreeNodeConfig BearTrapConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/stealth/bear_trap.png",
        NType = NodeType.SkillUnlock,
        NTab = SkillTreeTabs.Stealth,
        UpgradeCost = 1650,
    ...
    public static readonly SkillTreeNodeConfig ShadowStepConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/stealth/shadow_step.png",
        UnlockLevel = 13,
        MaximumLevel = 5,
        UpgradeGemCost = _tierTwoGemCost,
        GridX = 2,
    ...
    public static readonly SkillTreeNodeConfig BackstabConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/stealth/backstab.png",
        UnlockLevel = 18,
        MaximumLevel = 5,
        UpgradeGemCost = _tierTwoGemCost,
        GridX = 1,
    ...
    public static readonly SkillTreeNodeConfig NinjaMasteryConfig = new SkillTreeNodeConfig()
    {
        ...
        //AbilityPreviewPath = "Ability_Preview/stealth/ninja_mastery.png",
        UnlockLevel = 28,
        MaximumLevel = 1,
        GridX = 1,
        GridY = 3,
    ...
    public static readonly SkillTreeNodeConfig TotalDarknessConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/stealth/total_darkness.png",
        UnlockLevel = 23,
        MaximumLevel = 5,
        UpgradeGemCost = _tierTwoGemCost,
        GridX = 2,
    ...
    public static readonly SkillTreeNodeConfig IceFistNodeConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/elemental/ice_fist.png",
        UnlockLevel = 0,
        MaximumLevel = 5,
        UpgradeGemCost = _tierOneGemCost,
        NType = NodeType.SkillUnlock,
    ...
    public static readonly SkillTreeNodeConfig WindPunchNodeConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/elemental/wind_punch.png",
        UnlockLevel = 27,
        MaximumLevel = 5,
        UpgradeGemCost = _tierOneGemCost,
        NType = NodeType.SkillUnlock,
    ...
    public static readonly SkillTreeNodeConfig FireballNodeConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/elemental/fireball.png",
        UnlockLevel = 30,
        MaximumLevel = 5,
        UpgradeGemCost = _tierTwoGemCost,
        NType = NodeType.SkillUnlock,
    ...
    public static readonly SkillTreeNodeConfig ThunderboltNodeConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/elemental/thunderbolt.png",
        UnlockLevel = 26,
        MaximumLevel = 5,
        UpgradeGemCost = _tierOneGemCost,
        NType = NodeType.SkillUnlock,
    ...
    public static readonly SkillTreeNodeConfig IceStormNodeConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/elemental/ice_storm.png",
        UnlockLevel = 34,
        MaximumLevel = 5,
        UpgradeGemCost = _tierTwoGemCost,
        NType = NodeType.SkillUnlock,
    ...
    public static readonly SkillTreeNodeConfig ChargingStationNodeConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/elemental/charging_station.png",
        UnlockLevel = 32,
        MaximumLevel = 5,
        UpgradeGemCost = _tierTwoGemCost,
        NType = NodeType.SkillUnlock,
    ...
    public static readonly SkillTreeNodeConfig FireTornadoNodeConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/elemental/fire_tornado.png",
        UnlockLevel = 42, //42
        MaximumLevel = 5,
        UpgradeGemCost = _tierTwoGemCost,
        NType = NodeType.SkillUnlock,
    ...
    public static readonly SkillTreeNodeConfig MeteorStrikeNodeConfig = new SkillTreeNodeConfig()
    {
        ...
        AbilityPreviewPath = "Ability_Preview/elemental/meteor_crash.png",
        UnlockLevel = 44, //44
        MaximumLevel = 5,
        UpgradeGemCost = _tierThreeGemCost,
        NType = NodeType.SkillUnlock,
